...
{
    public class SaveTotalWageForEachCompony_UC9
    {
        ...
        public SaveTotalWageForEachCompony_UC9(string compony, int empRatePerHour, int numOfWorkingDays, int maxHoursPerMonth)
        {
